        ...
        <div class="card-body">
            <form method="POST" action="{{ route('posts.update', ['id' => $post]) }}" enctype="multipart/form-data">
                ...
                <div class="card-body2">
                    ...
                    <div class="hassyu-area-box">
                        <input id="tagInput" type="text" class="hassyu-area" name="hassyu" required autofocus
                            maxlength="30" placeholder="#ハッシュタグを3つまで追加" value="{{ $post->getTagsList() }}">
                    </div>
